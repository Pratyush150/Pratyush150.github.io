...
export const LAB_TILES: LabTile[] = [
  ...
  },
  {
    ...
    clip: 'lab-int8-cost',
    clipCaption:
      'The measured accuracy-versus-latency sweep. The fastest recipe on this chart scores zero.',
    span: 'lab-c',
  },
  {
    ...
    clip: 'lab-swarm-plan',
    clipCaption:
      '30 agents crossing random-32-32-20 under ECBS, planned to 1.024x of a proven lower bound.',
    span: 'lab-d',
  },
  {
    ...
    clip: 'lab-bow-recall',
    clipCaption:
      'Translation and rotation error against sub-sequence length on KITTI, the official metric.',
    span: 'lab-e',
  },
  {
